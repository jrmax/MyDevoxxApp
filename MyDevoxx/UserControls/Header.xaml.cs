...
namespace MyDevoxx.UserControls
{
    public sealed partial class Header : UserControl, INotifyPropertyChanged
    {
        ...
        private bool _indicatorFavorites = false;
        public bool IndicatorFavorites
        {
            get { return _indicatorFavorites; }
            set
            {
                _indicatorFavorites = value;
                NotifyPropertyChanged();
            }
        }
        ...
        {
            Country = (string)settings.Values[Settings.COUNTRY];
        }
        ...
        private void HandleMessage(MessageType messageType)
        {
            ...
            else if (messageType.Equals(MessageType.SHOW_FAVS))
            {
                IndicatorFavorites = true;
            }
            else if (messageType.Equals(MessageType.HIDE_FAVS))
            {
        ...
        private void ChangeConference_Click(object sender, RoutedEventArgs e)
        {
            ViewModelLocator.Cleanup();
            NavigationService.NavigateTo(ViewModelLocator.ConferenceSelectorViewKey);
        }
    }
}
